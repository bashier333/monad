...
import type { AgencyLoadMargin } from "@/lib/packs/agency/engine";
...
export default function RevisionRow({ load, history }: { load: AgencyLoadMargin; history: RevisionHistory[] }) {
