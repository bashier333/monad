// k6: 5 concurrent recomputes (P-355, E-435). Run: k6 run -e BASE=https://staging... -e SESSION=... [-e PACK=agency] k6/recompute.js
...
const PACK = __ENV.PACK === "agency" ? "agency" : "freight";

export default function () {
  const week = WEEKS[__VU % WEEKS.length];
  const res = http.post(
    `${__ENV.BASE}/api/answers/recompute`,
    JSON.stringify({ week, pack: PACK }),
