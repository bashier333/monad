  ...
  return (
    <main className="mx-auto max-w-4xl space-y-6 p-6 md:p-10">
      <div className="text-center">
        <h1 className="text-2xl font-bold ds-text">Pricing</h1>
        <p className="mt-1 ds-text-2">Start free. Pay when the answer runs your Monday meeting.</p>
        <p className="mt-1 text-sm">
          <Link href="/roi" className="underline ds-text-2">Estimate your savings first →</Link>
        </p>
      </div>
