# Usage pricing prep (P-222/P-224)

Status: designed, not live. Team is flat-rate; this activates when run volume justifies it.

## Design

- Meter: `MeterEvent(kind, qty)` already records upload/answer_view/recompute/brief/seat.
...
1. Create metered prices in Stripe; store IDs in env.
