...
export const PRESETS: VendorPreset[] = [
  ...
  },
  {
    ...
    headers: {
      ...
      origin: ["Project"],
      driver: ["Assignee"],
      detention: ["Description", "Notes"],
    },
  },
  {
    vendor: "frameio",
    headers: {
      loadId: ["Asset ID", "Version ID"],
      date: ["Uploaded", "Created"],
      origin: ["Project"],
      driver: ["Reviewer", "Commenter"],
      detention: ["Comment"],
    },
  },
  {
    vendor: "quickbooks",
    headers: {
      loadId: ["Invoice #", "RefNumber"],
      date: ["TxnDate", "Due Date"],
      revenue: ["Amount", "TotalAmt"],
      broker: ["Customer", "CustomerRef"],
    },
  },
  {
    vendor: "generic-agency",
    headers: {
      loadId: ["ID", "Ref", "Project"],
      date: ["Date"],
